...
// Test Points
    ...
    __Motor_DutyCycle_Chart__Entry = NTtable_TPoint->GetEntry("Motor_DutyCycle_Chart");
}
...
void SimulinkSmartDashboardInterface::PostStepCallback()
{
    ...
    __Motor_DutyCycle_Chart__Entry.SetDouble(Code_Gen_Model_B.Motor_DutyCycle_Chart);
    // Tunable Parameters
